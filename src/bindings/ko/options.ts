...
registerBindingHandler("ko.options", new OptionsBindingHandler());

class OptionsTextBindingHandler implements BindingHandler {

}

registerBindingHandler("ko.optionsText", new OptionsTextBindingHandler());

class OptionsValueBindingHandler implements BindingHandler {

}

registerBindingHandler("ko.optionsValue", new OptionsValueBindingHandler());
